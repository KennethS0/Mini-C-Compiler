  ...
  public java_cup.runtime.Symbol scan()
    ...
    public String toString() {
        ...
        if (!tablaSimbolos.isEmpty()) {
            ...
            for(Map.Entry<String, RegistroSemantico> entry : tablaSimbolos.entrySet()) {
                String key = entry.getKey();
                RegistroSemantico value = entry.getValue();
        ...
        if (!listaErroresSemanticos.isEmpty()) {
            ...
            for(int i = 0; i < listaErroresSemanticos.size(); i++) {
                result += listaErroresSemanticos.get(i) + "\n";
            }
        }
